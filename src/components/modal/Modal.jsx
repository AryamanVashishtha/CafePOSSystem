...
function Modal({ name, phoneNumber, email, setName, setPhoneNumber, setEmail, buyNow }) {
                                                ...
                                                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                                    <form
                                                        ...
                                                        onSubmit={(e) => {
                                                            ...
                                                            buyNow(); // Trigger your buyNow function
...
// Add prop validation for the Modal component
Modal.propTypes = {
